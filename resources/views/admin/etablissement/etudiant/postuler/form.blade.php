                        ...
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                @foreach($stage as $item)
                                    <tr>
                                        <td>{{ $item->date_fin }}</td><td>{{ $item->date_debut }}</td><td><a href="{{ url('storage/'.$item->fichier_join) }}"><i class="fa fa-eye" aria-hidden="true"></i></button></a></a></td><td>{{ $item->portee }}</td><td>{{ $item->entreprise }}</td>
                                        <td>
                                            <div class="col-md-12">
